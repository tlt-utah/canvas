...
function setKalturaIcon() {
    console.log(new Date() + ": finding Kaltura old icon ... " +  $('div[aria-label="Record/Upload Media"]').length);
    $('div[aria-label="Record/Upload Media"] > button > i').css('background-image', 'url("/images/webcam.png")');
}    
